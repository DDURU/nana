...
int a; //전역변수
	public static void main(String[] args) {
		 ...
		 * - 타입(데이터의 종류)과 변수명(변수의 이름)으로 변수를 만들수 있다.
		 * 
		 * <<사용 가능한 기본형 데이터의 종류>>
		 ...
		 *  <<명명규칙>>
		 *  - 블럭안에서 변수명은 중복될 수없다.
		 *  - 영문 대소문자, 한글, 숫자, 특수문자('_','$')를 사용할수 있다.(한글 사용은 자제하자)
	  ...
	  //문자열 : ""(큰따옴표)로 감싸진 글자
       ...
       _String = null;
        ...
        _byte =127;
        _int = 128;
        _byte = (byte)_int;//형변환 : 대이터 타입을 변환하는 것
	   ...
	   //위에서 만든 변수들을 표현범위가 작은 타입으로 형변환 해주세요(3번) 왼쪽이 작으면 됨
        _int = (int)_long;
        _long= (long)_float;
       //위에서 만든 변수들을 표현범위가 큰 타입으로 형변환 해주세요.(3번) 왼쪽이 크면 됨
...
//	System.out.println("입력받을 숫자 : " + input2);
...
//	int input2 = Integer.parseInt(s.nextLine());
	...
	//System.out.println(input2 + input3 + input4);
